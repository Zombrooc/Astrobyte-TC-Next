...
import { Container } from "../../styles/pages/courses/technology.styles";

export default function Technology() {
  return (
    <>
      <Head>
        <title>Astrobyte - Informática</title>
      </Head>
      <Navbar />
      ...
      <Container>
        ...
        <h2 style={{ textAlign: 'center', color: 'grey'}}>
          Tudo que você precisa saber para ingressar no mercado de trabalho.
        </h2>
        <br/>
        <br/>
        <br/>
        ...
        <div>
          <div>
            <img
              src="https://www.timeshighereducation.com/sites/default/files/styles/the_breaking_news_image_style/public/computer-programmer-coding-on-laptop.jpg"
              alt="Computador"
            />
          </div>
          <div>
